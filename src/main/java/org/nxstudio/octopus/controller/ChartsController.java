...
import org.nxstudio.octopus.service.StockService;
...
public class ChartsController {
	...
	public List<Object[]> getStockData(@PathVariable("symbol") String symbol) {
		...
		for (RawDataYahooHistorical record : stockService.getHistoricalDaily(symbol)) {
	...
	public List<Object[]> getStockDividend(@PathVariable("symbol") String symbol) {
		final List<Object[]> result = new LinkedList<>();
		for (RawDataYahooDividend record : stockService.getAllDividends(symbol.toUpperCase())) {
